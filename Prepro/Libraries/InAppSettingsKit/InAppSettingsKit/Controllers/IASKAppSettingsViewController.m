...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	if ([specifier.type isEqualToString:kIASKPSToggleSwitchSpecifier]) {
		...
		slider.value =	[self.settingsStore objectForKey:specifier.key] != nil ? [(NSNumber *)[self.settingsStore objectForKey:specifier.key] floatValue] : [(NSNumber *)specifier.defaultValue floatValue];
