...
#define kMessageWidth self.frame.size.width - 50
#define kX 30
#define kCenteredX self.frame.size.width/2
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        [NSException raise:@"init exception" format:@"Use ONLY initInViewController:viewController to init ALFSAlert object"];
    }
    return self;
}
